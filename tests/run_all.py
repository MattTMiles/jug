...
TESTS = [
    ...
    TestSpec(
        ...
        category="tempo2",
        description="Tempo2 residual parity against libstempo",
        timeout=240,
    ),
    TestSpec(
        ...
        category="tempo2",
        description="Tempo2 design-matrix parity against libstempo",
        timeout=240,
    ),
    TestSpec(
        ...
        category="tempo2",
        description="Tempo2 WLS fit parity against libstempo",
        timeout=240,
    ),
]

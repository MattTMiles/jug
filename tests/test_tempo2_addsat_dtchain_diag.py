...
# Measured 2026-07-08 on epta_j0613_t2_ipta_all (1369 TOA, post feedback-delta fix).
MEASURED_RMS_NS = 10.08
MEASURED_NON_ADDSAT_RMS_NS = 5.36
MEASURED_ADDSAT_MAX_NS = 217.9


def test_epta_j0613_feedback_delta_zero_and_debt_pins():
    """Merged IPTA chains: clkcorr 3−1 iter delta is zero; debt stays ~10 ns RMS."""
...
def test_epta_j0613_addsat_sat_matches_pytempo():
    ...
    # Addsat TOAs carry ~200 ns dt-chain debt (site-epoch), not SAT mis-application.
    assert report.addsat_toa_max_ns > 25.0
    assert report.non_addsat_rms_ns < 6.0
